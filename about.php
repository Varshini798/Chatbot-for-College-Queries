...
<head>
    ...
    <title>AI Chatbot - About Us</title>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-8 bg-indigo-100 p-6 rounded-lg shadow-md">
            ...
            <p class="text-gray-600 mb-4">
                Our vision is to transform the way students and the public access information related to college life and education. We aim to create a user-friendly and intuitive AI chatbot that serves as a reliable resource for anyone seeking assistance with college-related queries.
                By harnessing the power of artificial intelligence, we strive to empower users to navigate their educational journeys with confidence and ease.
            </p>
            <h3 class="text-2xl font-bold text-gray-800 mb-4">Our Mission</h3>
            <p class="text-gray-600 mb-4">
                Our mission is to provide an efficient AI chatbot that assists students and the public with a wide range of college-related inquiries. Whether you need information about course offerings, 
                admission processes, campus facilities, financial aid, or extracurricular activities, our chatbot is designed to deliver instant, accurate answers 24/7. We are committed to enhancing the college experience by making essential information readily accessible to all users.  
            </p>
            <h3 class="text-2xl font-bold text-gray-800 mb-4">Our Team</h3>
            <p class="text-gray-600 mb-4">
                Our team consists of passionate professionals with expertise in artificial intelligence, education, and technology. We are committed to helping students and the public succeed by continuously enhancing our chatbot's capabilities and ensuring it meets the evolving needs of our users.
                Together, we aim to create a supportive environment where everyone can easily access the information they need to thrive in their educational pursuits.            
            </p>
        </div>
    </div>
