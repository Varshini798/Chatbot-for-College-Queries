...
<body class="bg-gray-100">
    <nav class="bg-blue-100 shadow-md">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-800 text-center">Admin Dashboard</h2>
            <div class="mt-8 bg-white p-6 rounded-lg shadow-md">
                <h3 class="text-2xl font-bold text-gray-800 mb-4">User  Information</h3>
                <table class="min-w-full bg-white">
                    ...
                    <tbody id="user-table">
                        ...
                        ?>
                        <tr>
                            <td class="py-2 px-4 border-b border-gray-200"><?= $row['Username'] ?></td>
        ...
        <footer class="bg-blue-100 shadow-md mt-12">
            <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    <div>
                        <h2 class="text-lg font-bold text-gray-800">Follow Us</h2>
