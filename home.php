...
<div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
    <div class="md:w-1/2">
        <img alt="AI Chatbot illustration" class="rounded-lg shadow-lg" height="500" src="https://img.freepik.com/premium-photo/adorable-ai-chat-bot-cute-robot-with-headphones-blue-background-social-media-post-size_795881-37512.jpg" width="400"/>
    </div>
    <div class="md:w-1/2 md:pl-12 mt-8 md:mt-0">
        <h1 class="text-3xl font-bold text-gray-800">AI Chatbot for College Queries</h1>
        <p class="mt-4 text-blue-800">
            Our AI Chatbot is designed to assist students with all their college-related queries. Whether you need information about courses, admissions, campus facilities, or events, our chatbot is here to help you 24/7. Get instant answers and make your college experience smoother and more enjoyable.
        </p>
        <form action="category.php" method="post">
            <input type="hidden" name="redirect" value="true">
            <button type="submit" class="mt-6 inline-block bg-red-500 hover:bg-red-600 text-white font-medium py-2 px-4 rounded-md">Let's Start</button>
        </form>
    </div>
</div>

<footer class="bg-blue-100 shadow-md mt-12">
