...
<body class="bg-gray-100">
    <nav class="bg-blue-100 shadow-md">
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-bold text-gray-800 text-center">Search History</h2>
            <div class="mt-8 bg-indigo-100 p-6 rounded-lg shadow-md">
                <div id="history-box" class="h-64 overflow-y-auto border border-gray-300 p-4 rounded-lg">
                </div>
            </div>
        </div>
